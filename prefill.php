...
$replacements = [
    'Pbmedia\\\\ScoreMatcher\\\\'         => function () use (&$values) {return str_replace('\\', '\\\\', $values['psr4_namespace']) . '\\\\';},
    'Pascal Baljet'                       => function () use (&$values) {return $values['author_name'];},
    'pascalbaljet'                        => function () use (&$values) {return $values['author_github_username'];},
    'https://pascalbaljetmedia.com'       => function () use (&$values) {return $values['author_website'] ?: ('https://github.com/' . $values['author_github_username']);},
    'pascal@pascalbaljetmedia.com'        => function () use (&$values) {return $values['author_email'] ?: ($values['author_github_username'] . '@example.com');},
    'Pbmedia'                             => function () use (&$values) {return $values['package_vendor'];},
    'ScoreMatcher'                        => function () use (&$values) {return $values['package_name'];},
    'Match scores with object attributes' => function () use (&$values) {return $values['package_description'];},
